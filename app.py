...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # ================================================================
        # RIGHT COLUMN (camera + cropped + similarity + minimal controls)
        # ================================================================
        ...
        # Camera-side controls (start/stop/freeze/unfreeze + detection threshold)
        right_controls = self._create_camera_controls_panel()
        ...
        # camera at top
        right_layout.addWidget(self.video_label, stretch=5)

        # cropped + similarity
        bottom_row = QHBoxLayout()
        bottom_row.setContentsMargins(0, 0, 0, 0)
        bottom_row.setSpacing(4)
        bottom_row.addWidget(self.cropped_label, stretch=1)
        bottom_row.addWidget(self.similarity_widget, stretch=2)
        right_layout.addLayout(bottom_row, stretch=3)

        # minimal controls
        right_layout.addWidget(right_controls, stretch=2)

        right_widget = QWidget()
        right_widget.setLayout(right_layout)

        # ================================================================
        # LEFT COLUMN (embeddings + NeuralHash + hash controls)
        # ================================================================
        ...
        nh_layout.setContentsMargins(4, 20, 4, 4)
        nh_layout.setSpacing(4)

        nh_top_row = QHBoxLayout()
        nh_top_row.setContentsMargins(0, 0, 0, 0)
        nh_top_row.setSpacing(4)
        ...
        # hash-side controls: projection + hash threshold + copy/clear
        left_controls = self._create_hash_controls_panel()
        ...
        # top ~45%: embeddings
        left_layout.addWidget(self.embedding_plot, stretch=9)
        # middle: NeuralHash
        left_layout.addWidget(nh_group, stretch=7)
        # bottom: hash controls
        left_layout.addWidget(left_controls, stretch=4)

        left_widget = QWidget()
        left_widget.setLayout(left_layout)

        # ================================================================
        # MAIN LAYOUT: left (analytics) | right (camera)
        # ================================================================
        main_widget = QWidget()
        main_layout = QHBoxLayout()
        main_layout.setContentsMargins(0, 0, 0, 0)
        main_layout.setSpacing(2)
        main_layout.addWidget(right_widget, 4)   # camera side on the LEFT
        main_layout.addWidget(left_widget, 6)    # embeddings + NeuralHash on the RIGHT
    ...
    def _create_camera_controls_panel(self) -> QWidget:
        """
        Right column: only Start/Stop/Freeze/Unfreeze + detection threshold.
        """
    ...
    def _create_hash_controls_panel(self) -> QWidget:
        """
        Left column bottom: projection selector + hash threshold +
        copy last hash + clear history.
        """
        group = QGroupBox("Hash / Projection Controls")
        layout = QVBoxLayout()
